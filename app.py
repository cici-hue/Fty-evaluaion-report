                ...
                "sub_modules": {
                    ...
                    "小项2. 工艺标准传达及预防措施": {
                        "items": [
                            ...
                            {"id": "pp2_4_a", "name": "重点工序难点（制作领子，门襟等小样）及解决方案", "score": 1, "is_key": False, "details": [], "comment": "给车间生产员工一个质量标准参照"},
                            {"id": "pp2_4_b", "name": "试生产样的外观/尺寸/克重/试身的问题及解决方案", "score": 1, "is_key": False, "details": [], "comment": ""},
                            {"id": "pp2_4_c", "name": "对条对格，花型定位等要求", "score": 1, "is_key": False, "details": [], "comment": ""},
                            {"id": "pp2_4_d", "name": "特别关注撕裂强度的缝制工艺的风险", "score": 1, "is_key": False, "details": [], "comment": ""},
                            {"id": "pp2_4_e", "name": "特别关注粘衬环节的风险（颜色差异，透胶，粘衬颜色）", "score": 1, "is_key": False, "details": [], "comment": ""},
                            {"id": "pp2_4_f", "name": "轻薄产品包装方法风险评估（皱，滑落等）", "score": 1, "is_key": False, "details": [], "comment": ""},
                        ]
                    },
                    "小项3. 技术难点分析": {
                        "items": [
                ...
                "sub_modules": {
                    ...
                    "小项2. 点位及小烫": {
                        "items": [
                            ...
                            {"id": "s2_4_烫台", "name": "烫台用白布包裹及台面干净整洁，定期更换", "score": 1, "is_key": False, "details": [], "comment": ""},
                            {"id": "s2_5_烫斗", "name": "烫斗温度和面料匹配（建议真丝面料低于110度）", "score": 1, "is_key": False, "details": [], "comment": ""},
                            {"id": "s2_6_手法", "name": "烫工的操作手法是否正确（见指南）", "score": 1, "is_key": False, "details": [], "comment": ""},
                            {"id": "s2_7_激光", "name": "查验是否有激光印/透胶", "score": 1, "is_key": False, "details": [], "comment": ""},
                            {"id": "s2_8_变形", "name": "查验是否变型/变色", "score": 1, "is_key": False, "details": [], "comment": ""},
                            {"id": "s2_9_粘衬", "name": "查验粘衬牢固度", "score": 1, "is_key": False, "details": [], "comment": ""},
                        ]
                    },
                    "小项3. 缝制中": {
                        "items": [
